  ...
  const columns = useMemo<ColumnDef<AttendanceLogResponse>[]>(() => {
    const cols: ColumnDef<AttendanceLogResponse>[] = [
      ...
      },
      {
        ...
        cell: (log) => (
          <div className="flex items-center gap-2">
            ...
            {log.punchInTime && (
              <span className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${log.locationVerifiedIn ? "bg-emerald-400" : "bg-red-400"}`}
        ...
        cell: (log) => (
          <div className="flex items-center gap-2">
            ...
            {log.punchOutTime && log.locationVerifiedOut !== null && (
              <span className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${log.locationVerifiedOut ? "bg-emerald-400" : "bg-red-400"}`}
      ...
      },
      {
        header: "Overtime",
        cell: (log) => {
          if (log.overtime && log.overtimeMinutes > 0) {
            return (
          ...
          return <span className="text-gray-300 dark:text-gray-700 text-sm">—</span>;
        }
      },
      {
        header: "Status",
        ...
        cell: (log) => (
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 text-[11px] font-bold rounded-lg border border-gray-200 dark:border-gray-700 transition-all active:scale-95"
            ...
            {log.correctionStatus === "PENDING" && (
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-[11px] font-bold rounded-lg shadow-sm shadow-indigo-200 dark:shadow-indigo-900/40 transition-all animate-pulse hover:animate-none"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
            ...
            {log.overtime && log.overtimeMinutes > 0 && !log.isOvertimeApproved && (
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 bg-violet-600 hover:bg-violet-700 text-white text-[11px] font-bold rounded-lg shadow-sm shadow-violet-200 dark:shadow-violet-900/40 transition-all active:scale-95"
              >
            ...
            <div className="flex items-center justify-end w-full">
              {canRequestCorrection && (
                isLocked ? (
                  ...
                  <button
                    onClick={() => setCorrectionTarget(log)}
                    className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-semibold rounded-lg text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 hover:text-indigo-600 dark:hover:text-indigo-400 hover:border-indigo-300 dark:hover:border-indigo-800 transition-all whitespace-nowrap"
                  >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
